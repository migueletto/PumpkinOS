...
{
    // libgdoomn: print a single status line on the bottom
    //int		i;
...
*/
    ...
    DG_Status(*w_health.n.num, *w_armor.n.num, *w_ammo[0].num, *w_maxammo[0].num, *w_ammo[1].num, *w_maxammo[1].num, *w_ammo[2].num, *w_maxammo[2].num, *w_ammo[3].num, *w_maxammo[3].num, st_faceindex);
...
static int yyy = 0;
void xxx(void) {
  V_DrawPatch(0, 0, faces[yyy++]);
  if (yyy == ST_NUMFACES) yyy = 0;
}
*/
