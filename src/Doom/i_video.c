...
void I_InitGraphics (void)
{
    ...
    DG_debug(1, "framebuffer: x_res: %d, y_res: %d, x_virtual: %d, y_virtual: %d, bpp: %d",
            s_Fb.xres, s_Fb.yres, s_Fb.xres_virtual, s_Fb.yres_virtual, s_Fb.bits_per_pixel);
    ...
    DG_debug(1, "framebuffer: RGBA: %d%d%d%d, red_off: %d, green_off: %d, blue_off: %d, transp_off: %d",
            s_Fb.red.length, s_Fb.green.length, s_Fb.blue.length, s_Fb.transp.length, s_Fb.red.offset, s_Fb.green.offset, s_Fb.blue.offset, s_Fb.transp.offset);

    //printf("I_InitGraphics: DOOM screen size: w x h: %d x %d\n", SCREENWIDTH, SCREENHEIGHT);
    DG_debug(1, "DOOM screen size: w x h: %d x %d", SCREENWIDTH, SCREENHEIGHT);
...
//debug(1, "XXX", "palette %02X: %02X %02X %02X", i, colors[i].r, colors[i].g, colors[i].b);
    }
}
