...
static void DayViewLoadTable (void) EXTRA_SECTION_THREE;

static void DayViewLayoutDay (Boolean retieve) EXTRA_SECTION_THREE;

static void DayViewDrawTimeBars (void) EXTRA_SECTION_THREE;

static void DayViewInitRow (TablePtr table, UInt16 row, UInt16 apptIndex, 
	Int16 rowHeight, UInt32 uniqueID, UInt16 iconsWidth, FontID fontID) EXTRA_SECTION_THREE;

static void DayViewUpdateDisplay (UInt16 updateCode) EXTRA_SECTION_THREE;

static Err SplitRepeatingEvent (UInt16* indexP) EXTRA_SECTION_THREE;

//static Boolean RepeatDescRectHandler(FormGadgetType *gadgetP, UInt16 cmd, void *paramP);
static Boolean RepeatDescRectHandler(FormGadgetTypeInCallback *gadgetP, UInt16 cmd, void *paramP) EXTRA_SECTION_THREE;
...
static DetailsPtr DetailsInit (void) EXTRA_SECTION_THREE;
 ...
 *
 ***********************************************************************/
static Boolean SetDateToNextOccurrence (UInt16 recordNum) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static Boolean GetTime (TimePtr startP, TimePtr endP, UInt16 titleStrID) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void ShowObject (FormPtr frm, UInt16 objectID) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void HideObject (FormPtr frm, UInt16 objectID) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static Boolean DeleteRecord (UInt16 recordNum) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static Err CreateException (ApptDBRecordPtr newRec, UInt16* indexP) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static Boolean CreateNote (Boolean prompt) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static Boolean DeleteNote (Boolean exception, Boolean splitEvent) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static Err SplitRepeatingEvent (UInt16* indexP) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static Boolean PurgeRecords (void) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static UInt16 DatebookDayOfWeek (UInt16 month, UInt16 day, UInt16 year) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static Char* SubstituteStr (Char* str, const Char* token, Char* sub, UInt16 subLen) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static FontID SelectFont (FontID currFontID) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void RepeatSetDateTrigger (DateType endDate) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void RepeatGetUIValues (FormPtr frm, RepeatInfoPtr repeatP) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void RepeatSetUIValues (FormPtr frm, RepeatInfoPtr repeatP) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void RepeatDrawDescription (FormPtr frm) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void RepeatSelectEndDate (EventType* event) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void RepeatChangeRepeatOn (EventType* event) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void RepeatChangeType (EventType* event) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void RepeatApply (void) EXTRA_SECTION_FOUR;
...
//static Boolean RepeatDescRectHandler(FormGadgetType *gadgetP, UInt16 cmd, void *paramP)
static Boolean RepeatDescRectHandler(FormGadgetTypeInCallback *gadgetP, UInt16 cmd, void *paramP) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void RepeatInit (FormPtr frm) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
 static void DetailsAlarmOnOff (Boolean on) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void DetailsSetTimeTrigger (TimeType start, TimeType end) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void DetailsSelectTime (TimePtr startP, TimePtr endP) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static void DetailsSelectDate (DetailsPtr details) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static Boolean DetailsDeleteAppointment (void) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static Boolean DetailsGet (DetailsPtr details) EXTRA_SECTION_FOUR;
 ...
 *
 ***********************************************************************/
static Boolean DetailsApply (DetailsPtr details, Boolean attachNote, UInt16* updateCodeP) EXTRA_SECTION_FOUR;
static Boolean DetailsApply (DetailsPtr details, Boolean attachNote, UInt16* updateCodeP)
{
	Err					err = 0;
	UInt16				attr;
	UInt16				id;
 ...
 *
 ***********************************************************************/
static void DetailsExit(void) EXTRA_SECTION_FOUR;
	...
	RectanglePtr bounds)
{
	...
	ApptInfoPtr 	appts;
	ApptDBRecordType apptRec;
	IndexedColorType fieldLine, oldf;
	...
	x += bounds->extent.x - TblGetItemInt (table, row, column);
	...
	if (recordNum == emptySlot)
		...
		*fontIdP = apptTimeFont;
		...
		//		else
			...
			//curFont = FntSetFont (FossilSymbolFont);
...
static Boolean DayViewNewAppointment (EventType* event)
{
	...
	startTime.hours = startTime.minutes = 0xFF;
	endTime.hours = endTime.minutes = 0xFF;
	*desc = 0;
