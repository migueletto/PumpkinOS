...
#define EXTRA_SECTION_THREE  __attribute__ ((section ("code3")))
#define EXTRA_SECTION_FOUR   __attribute__ ((section ("code4")))
#else
#define EXTRA_SECTION_ONE
#define EXTRA_SECTION_TWO
#define EXTRA_SECTION_THREE
#define EXTRA_SECTION_FOUR
#endif
