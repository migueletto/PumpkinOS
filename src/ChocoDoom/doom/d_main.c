...
void D_DoomMain (void)
{
	...
	if (scale > 400)
	    scale = 400;
        DG_debug(DEBUG_INFO, "turbo scale: %i%%", scale);
...
//    W_PrintDirectory();
    ...
    {
        I_PrintDivider();
        DG_debug(DEBUG_ERROR, "WARNING: The loaded WAD file contains modified sprites or"
    ...
    if (M_CheckParmWithArgs("-statdump", 1))
    {
        ...
        DG_debug(DEBUG_INFO, "External statistics registered");
    }
#endif
