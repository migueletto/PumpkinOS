...
*/
uint pmmu_translate_addr(m68k_state_t *m68k_state, uint addr_in)
{
...
void m68881_mmu_ops(m68k_state_t *m68k_state)
{
	uint16 modes;
					...
					switch ((modes>>13) & 0x7)
					{
						...
						case 2:	// MC68881 form, FD never set
							if (modes & 0x200)
							{
							 	switch ((modes>>10) & 7)
								{
									case 0:	// translation control register
										WRITE_EA_32(m68k_state, ea, m68ki_cpu.mmu_tc);
										break;

									case 2: // supervisor root pointer
										WRITE_EA_64(m68k_state, ea, (uint64)m68ki_cpu.mmu_srp_limit<<32 | (uint64)m68ki_cpu.mmu_srp_aptr);
										break;

									case 3: // CPU root pointer
										WRITE_EA_64(m68k_state, ea, (uint64)m68ki_cpu.mmu_crp_limit<<32 | (uint64)m68ki_cpu.mmu_crp_aptr);
										break;
							...
							else
							{
								...
								{
									case 0:	// translation control register
										m68ki_cpu.mmu_tc = READ_EA_32(m68k_state, ea);
									...
									case 2:	// supervisor root pointer
										temp64 = READ_EA_64(m68k_state, ea);
						...
						case 3:	// MC68030 to/from status reg
							if (modes & 0x200)
							{
								WRITE_EA_32(m68k_state, ea, m68ki_cpu.mmu_sr);
							}
							else
							{
								m68ki_cpu.mmu_sr = READ_EA_32(m68k_state, ea);
							}
							break;
