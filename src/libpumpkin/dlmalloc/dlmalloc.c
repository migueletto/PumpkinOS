...
#define assert(__e) ((__e) ? (void)0 : heap_assert(__FILE__, __LINE__, __FUNCTION__, #__e))
#else
...
#define get_malloc_state() ((struct malloc_state *)dlmalloc_get_state())
